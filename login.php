...
<?php
    if(isset($_POST['btSignup'])){
        ...
        $conn = mysqli_connect("localhost", "root", "", "dbnguoidung") or die("Khong ket noi duoc");
        ...
        <div class="content-top">
            ...
            <div class="content-top-form">
                <form class="content-form" action="<?php if(isset($_SERVER['PHP_SELF'])) echo $_SERVER['PHP_SELF'] ?> " method="POST">
                    <input class="input" type="text" name="nameuser" placeholder="Tên đăng nhập" value="<?php if(isset($tendn)) echo $tendn?>" required>
                    ...
                    <a class="text-forgot-pass" href="changepass.php">Quên mật khẩu?</a>
